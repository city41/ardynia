...
const uint8_t DIRT_FLOOR       = 0b00000001; // walkable; number 1
const uint8_t STONE_WALL       = 0b10000010; // solid; number 2
const uint8_t UNLOCKED_DOOR    = 0b01000011; // walkable; teleporter; number 3
const uint8_t LOCKED_DOOR      = 0b10000100; // solid; number 4
